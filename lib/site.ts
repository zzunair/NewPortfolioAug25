...
export const SITE_TITLE = "Zunair Shahid | Certified Shopify Plus Developer";
export const JOB_TITLE = "Certified Shopify Plus Developer";
export const TWITTER_HANDLE = "@zunair_says";
export const OG_IMAGE = "/images/others/dp.png";
export const YEARS_EXPERIENCE = "8+";

export const AUTHOR_BIO =
  "Zunair Shahid — Certified Shopify Plus developer, 8+ years, 100+ stores. Custom builds, WooCommerce migrations & long-term retainer partnerships for US, UK & Canada brands.";
